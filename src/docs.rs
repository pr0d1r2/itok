...
const COMMANDS: &[Command] = &[
    ...
    Command {
        name: "doctor",
        synopsis: "doctor [--model X[,Y...]] [--window N] [--ollama[=HOSTS]] [--format human|json] [-C dir] [paths...]",

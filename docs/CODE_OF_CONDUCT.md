...
estimate is wrong" invites the input that shows it. It is a repository built
around the idea that a number should name its own method, and the same standard
applies to the arguments made about it — by maintainers exactly as much as by
contributors. Pushing back on an unsupported claim, including one of ours, is
participation rather than rudeness.
...
- Personal information stays private unless the person it belongs to shares it.
  This project handles conversation transcripts; treat anything you see in
  someone's reproduction case as theirs, not as material.
